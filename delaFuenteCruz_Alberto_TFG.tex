...
\newline \newline
Esta información, además, será pública y podrá ser consumida a través de una API. De esta forma se promueve la consulta libre de estos datos al público, dado hasta ahora cada compañía jamás ha liberado los resultados de este proceso, convirtiéndose en fórmulas de éxito protegidas bajo siete llaves. Se pretende abrir esta base de conocimiento, puesto que no sólo sirve para incrementar los beneficios de un negocio, puesto que cuenta con el potencial suficiente como para tener un impacto real y positivo en la vida de las personas, más allá de sugerir amistades o zapatillas. 
