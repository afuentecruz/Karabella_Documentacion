...
En esta sección veremos varios diagramas de actividad destinados a clarificar y documentar cual es el flujo lógico que realiza la aplicación a la hora de analizar y extraer el contenido de cada de las aplicaciones propuestas. 
\subsection{Gmail}

%%% ------ 
\begin{figure}[H]
		\includegraphics[width=1.4\textwidth,center]{pictures/activity/gmailActivityDiagram.png} 
  \caption[Diagrama actividad GMail]{Diagrama de actividad del proceso de captura de gmail.}
