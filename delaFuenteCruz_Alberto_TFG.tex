...
\end{figure}
\end{landscape}
Como vemos, el algoritmo de captura recae en su mayor parte en el WhatsappAnalyzerImpl. Vemos sendas actividades vinculadas a métodos. Veamos en que consisten estos métodos, puesto que conforman los pilares sobre los que se asientan la caputura. 
...
\subsubsection{storePreviousDtoInRealm()}
