...
Hasta ahora hemos visto los métodos de captura de información a través de la web, pero en los últimos 10 años el mercado ha cambiado mucho con la aparición del smartphone, considerando 2008 como el año 0, puesto fué en ese año donde la Android debutó por primera vez, ocupando dos años después gran parte del mercado. 
\newline \newline 
Es por tanto una línea muy a tener en cuenta, estamos hablando de que llevamos un dispositivo inteligente con nosotros todo el día que se ha convertido en una extensión más de nuestro cuerpo. Pensar que aún teniendo eso en el bolsillo aún somos anónimos es pecar de optimistas. Estudiemos entonces si Google aprovecha esta plataforma para recopilar datos de sus usuarios y cómo lo hace. 
\subsection{a buscar como un cerdo!}
