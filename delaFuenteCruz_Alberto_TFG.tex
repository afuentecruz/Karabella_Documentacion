...
\chapter{Análisis}
En esta capítulo se describe el análisis del problema mediante su especificación de requisitos. Nuestro objetivo final será monitorizar las aplicaciones del usuario y registrar información acerca de cómo éste interactúa con el medio.
\newpage
\section{Requisitos}
